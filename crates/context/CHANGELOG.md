...
## [8.0.3](https://github.com/zilayo/revm/compare/revm-context-v8.0.2...revm-context-v8.0.3) - 2025-07-05

### Fixed

- fix typo: Rename is_created_globaly to is_created_globally ([#2692](https://github.com/zilayo/revm/pull/2692))

### Other

- add comprehensive tests for TxEnvBuilder ([#2690](https://github.com/zilayo/revm/pull/2690))
